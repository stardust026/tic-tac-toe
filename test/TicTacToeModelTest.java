...
public class TicTacToeModelTest {
  ...
  @Test public void testHorizontalWin() {
  ...
  @Test public void testDiagonalWin() {
    diagonalWinHelper();
    assertTrue(ttt1.isGameOver());
  ...
  @Test public void testInvalidMove() {
    ...
    try {
      ...
      assertEquals("Occupied", iae.getMessage());
    ...
    try {
      ...
      assertEquals("Out of range", iae.getMessage());
      assertTrue(iae.getMessage().length() > 0);
    }
  }
   ...
   */
  @Test public void testFullBoardAndWinner() {
    ttt1.move(0, 1);
    ttt1.move(1, 1);
    ttt1.move(0, 2);
    ttt1.move(1, 2);
   ...
   * test vertical win.
   */
  @Test public void testVerticalWin() {
    ttt1.move(0, 1);
    ttt1.move(0, 0);
    ttt1.move(1, 1);
    ttt1.move(1, 0);
  ...
  @Test public void testGetMarkAt() {
    ttt1.move(0, 1);
    ttt1.move(0, 0);
    assertEquals(Player.X, ttt1.getMarkAt(0, 1));
    assertEquals(Player.O, ttt1.getMarkAt(0, 0));
  }
}
